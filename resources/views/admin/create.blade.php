...
@endif
                ...
                <div class="card"
                        ...
                        <div style="display:flex">
                            <input type="text" id="day" readonly name="day" style="width:80px;border:none">
                            <hr style="height:18px;width:2px;background-color:black;margin-left:5px;margin-top:5%">
                            @foreach($users as $g)
                            <p style="margin-left:5px;margin-top:5%">{{$g->from_time}} - {{$g->end_time}}</p>
                           @endforeach
                        </div>
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content" style="width:600px;padding:20px">
                                        ...
                                        <div style="display:flex">
                                            ...
                                            @foreach($users as $g)
                                            <p style="margin-left:10%">Shift Time:{{$g ->from_time}}:{{$g ->end_time}}</p>
                                           
                                            <p style="margin-left:10%">Shift Type :{{$g ->Shift_type}}</p>
                                            @endforeach
                                        </div>
