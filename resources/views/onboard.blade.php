                    ...
                    <div id="content">
                        ...
                        <form action="" method="post">
                            ...
                            <div>
                                ...
                                <div class="form-group c1">
                                    <div class="">
                                        ...
                                        <input type="text" class="form-control" placeholder=" International Employee "
                                            name="internationalemployee" style=" font-size:15px;">
                                ...
                                <div class="form-group c2">
                                    <div class="">
                                        ...
                                        <input type="text" class="form-control" placeholder=" Physically Challenged "
                                            name="physicallychallenged" style=" font-size:15px;">
                            ...
                            <div style="display: flex">
                                ...
                                <button id="btntwo" class="btn btn-outline-primary btn-lg" type="cancel">
