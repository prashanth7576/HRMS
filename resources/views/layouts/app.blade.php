                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="leave"> Leave Apply </a></li>
                                <li><a class="dropdown-item" href="leavebalance"> Leave Balances </a></li>
                                <li><a class="dropdown-item" href="leavecalendar"> Leave Calendar </a></li>
                                <li><a class="dropdown-item" href="holidaycalendar"> Holiday Calendar </a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="attendanceinfo"> Attendance Info </a></li>

                            </ul>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="documentcenter"> Document Center</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="people"> People </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="helpdesk"> Helpdesk</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="menu">
            ...
            <div class="item">
                ...
                <div class="sub-menu">
                    ...
                    <a href="holidaycalendar" class="sub-item">Holiday Calendar</a>
                </div>
            ...
            <div class="item"><a href="people"><i class="fa fa-users"></i>People</a></div>
